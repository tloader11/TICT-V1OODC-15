...
//this is where we put the code for the user interface
    ...
    public void start(Stage primaryStage) {
        Medewerker m1 = new Medewerker("ZijnNaam1","89235765","stucador", true);
        Medewerker m2 = new Medewerker("ZijnNaam2","89235765","loodgieter", true);
        ...
        ChoiceBox medewerkers = new ChoiceBox(FXCollections.observableArrayList(m1.getNaam(), m2.getNaam()));
        //Add the label and choicebox to the flowpane
        choicePane.getChildren().add(choiceLbl);
        choicePane.getChildren().add(medewerkers);
